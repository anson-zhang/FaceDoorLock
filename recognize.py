	...
	if cv2.waitKey(5) & 0xFF == ord('t'):
		...
		for (x, y, w, h) in faces:
			...
			if conf < 50.0:
				...
				cv2.putText(col_img, "Welcome " + str(dic[str(label_predict)]) + "!", (0, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255 ,0))
				...
				if conf < 100.0:
					cv2.rectangle(col_img, (x, y), (x + w, y + h), (0, 255, 0), 2)
					cv2.putText(col_img, "Sorry! You are not allowed to come in.", (0, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255 ,0))
